import type { ButtonHTMLAttributes, CSSProperties, DetailedHTMLProps, HTMLAttributes } from "react";
    ...
    return (
        <div>
            ...
            <LayoutComparer
                style={{
                    backgroundColor: "var(--accents-1)",
                    aspectRatio: "var(--grid-division)/2",
                    paddingInline: "var(--site-padding)",
                    borderInline: "1px solid var(--grid-color)"
                }}
            >
                <WebButton name="Default Unstyled">{buttonText}</WebButton>
                <WebButton name="Default Unstyled" styled>
                    {buttonText}
                </WebButton>
            </LayoutComparer>
        </div>
